package com.ferelin.features.search.data

import com.ferelin.core.checkBackgroundThread
import com.ferelin.features.search.data.entity.SearchRequestsDBO
import com.ferelin.features.search.data.entity.SearchRequestsDao
import com.ferelin.features.search.data.mapper.SearchRequestMapper
...
internal class SearchRequestsRepositoryImpl @Inject constructor(
  private val dao: SearchRequestsDao
  ...
  override suspend fun add(request: String) {
    ...
    dao.insert(
      searchRequestsDBO = SearchRequestsDBO(request = request)
    )
  }
