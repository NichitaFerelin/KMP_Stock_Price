...
class ChartFragmentTest {
    ...
    fun widgetsDisplayed() {
        ...
        onView(withId(R.id.textViewDayProfit)).check(matches(isDisplayed()))
        onView(withId(R.id.cardViewBuy)).check(matches(isDisplayed()))
        onView(withId(R.id.textViewBuyPrice)).check(matches(isDisplayed()))
    }
}