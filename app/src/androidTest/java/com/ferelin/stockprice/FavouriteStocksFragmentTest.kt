...
// Works only when favourite items are exist
@RunWith(AndroidJUnit4::class)
class FavouriteStocksFragmentTest {
    ...
    @Before
    fun replaceFragment() {
        onView(withId(R.id.textViewHintFavourite)).perform(ViewActions.swipeLeft())
    }
    ...
    fun navigationByClickOnStock() {
        onView(withId(R.id.recyclerViewFavourites))
