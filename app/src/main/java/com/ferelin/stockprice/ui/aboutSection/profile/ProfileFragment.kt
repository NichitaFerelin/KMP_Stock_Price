...
class ProfileFragment(
    private val mCoroutineContextProvider: CoroutineContextProvider = CoroutineContextProvider(),
    private val mSelectedCompany: AdaptiveCompany? = null
) : Fragment() {

    private var mBinding: FragmentProfileBinding? = null
    private val mViewModel: ProfileViewModel by viewModels {
        CompanyViewModelFactory(
            mCoroutineContextProvider,
            (activity as MainActivity).dataInteractor,
            mSelectedCompany
        )
    }
